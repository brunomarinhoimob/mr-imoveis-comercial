...
# ---------------------------------------------------------
# CARREGAR E PREPARAR DADOS (MESMA LÓGICA DO RANKING CORRETOR)
# ---------------------------------------------------------
...
# remove equipes totalmente zeradas
rank_eq = rank_eq[
    (rank_eq["ANALISES"] > 0)
...
st.markdown(
    ...
    "Ranking por equipe baseado em análises, aprovações, vendas e VGV do período filtrado."
    "</p>",
